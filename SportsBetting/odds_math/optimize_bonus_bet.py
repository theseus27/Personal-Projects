...
BONUS_VAL = 20
#TEST_AMOUNTS = [0, BONUS_VAL / 10, BONUS_VAL / 5, BONUS_VAL / 3, BONUS_VAL / 2, BONUS_VAL, BONUS_VAL*1.1, BONUS_VAL*1.25, BONUS_VAL*1.33, BONUS_VAL*1.5, BONUS_VAL*1.67, BONUS_VAL*1.75, BONUS_VAL*2]
...
def calc_profs(am_odds, amounts, bonus_idx):
    ...
    for i in range(len(am_odds)):
        if i == bonus_idx:
            ...
            profits.append(profit(am_odds[i], amounts[i]) + amounts[i] * 1.5 - spent)
    return profits
